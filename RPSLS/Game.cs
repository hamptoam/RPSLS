...
namespace RPSLS
{
    class Game
    {
        ...
        public void choosePlayers()
        {
            ...
            do
            {
                try
                {
                    ...
                    numPlayers = int.Parse(oneOrTwoPlayers);

                }
                catch (SystemException)
                {
                    Console.WriteLine("Must input a numeral 1 or 2");
                }

                if (numPlayers > 2 || numPlayers < 1) 
                {
                    Console.WriteLine("I said 1 or 2.");
                }
            ...
            //^^ first catch exception, after finding System Exception
            //and just int.Parse not assigned to a number
            //runs smoothly and "flamingo" did not pass 
            ...
            switch (numPlayers)
            {
                ...
                case 2:
                    ...
                    {
                        Console.WriteLine("Please enter different nicknames.");
                    }
        ...
        public void winnerandLoser()
        {
            ...
            if(player1Move == "Flamingo")
            {
                throw new SystemException("You know what you did.");
